...
public class WebHandler {
     ...
     * @param map
     */
    public static void toMap(Object obj, Map map) {
     ...
     *
     * @param map   通过toPO封装的MAP值
     * @param clazz 通过toPO封装的泛类型
     */
     ...
     *
     * @param map 通过toPO封装的MAP值
     * @param obj 通过toPO封装的泛类型，可以是存在的obj，也可以是第一次新建的obj
     */
    ...
    public static void toQueryPo(HttpServletRequest request, QueryObject qo,
        ...
        try {
            Object obj = BeanUtils.instantiateClass(classType);
            BeanWrapper wrapper = new BeanWrapperImpl(obj);
            PropertyDescriptor[] propertys = wrapper
                    .getPropertyDescriptors();
            Map map = request.getParameterMap();
                                ...
                                if (pd.getName().equals(propertyName)) {
                                    ...
                                    for (PropertyDescriptor many_to_one_pd : entity_propertys) {
                                        if (many_to_one_pd.getName().equals(
                                            ...
                                            para = Convert.convert(many_to_one_pd
                                                    .getPropertyType(), map
                                                    .get(field));
                                        }
                                    }
