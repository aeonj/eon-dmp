...
import eon.hg.fap.core.beans.exception.BeansException;
...
public abstract class BeanUtils {
	 ...
	 */
	public static <T> T instantiateClass(Class clazz) throws BeansException {
	 ...
	 * @return 被创建的类实例
	 */
	public static <T> T instantiateClass(Constructor contor, Object[] args) throws BeansException {
		...
		try {
			...
			return (T) contor.newInstance(args);
		}		
		catch (Exception ex) {
