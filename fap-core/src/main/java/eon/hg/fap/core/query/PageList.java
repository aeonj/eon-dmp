 ...
 * 
 * <p>
* 实现通过调用IQuery实现分页处理，其它特殊形式的分页查询需求只需要继承该类即可，比如DbPageList。
...
public class PageList implements IPageList {
	 ...
	 */
	public void doList(int pageSize, int pageNo, String querySql, String totalSQL,
			String condition) {
		doList(pageSize, pageNo, querySql, totalSQL, condition, null);
	}
