...
#pagination li { display:block; background: url(resource/image/cloud/btn_bg2.png)  no-repeat; list-style:none; width:16px; height:16px; float:left; margin-left:0px; }
#pagination li a { display:block; width:100%; height:100%; padding:0; margin:0;  text-indent:-9999px;}
#pagination li.current { background: url(resource/image/cloud/btn_bg1.png)  no-repeat; width:16px; height:16px;}
...
.login-modern-a {border: 1px solid transparent;background:url(resource/image/cloud/login-bg.png) no-repeat;}
...
#banner .login-box-a .nav a.dz1{  background:url(resource/image/cloud/email-h.png) no-repeat; width:212px; height:46px; float:left; display:block; font-size:16px; color:#6a6767; line-height:63px; text-align:center}
...
#banner .login-box-a .nav a.dz2{ background:url(resource/image/cloud/tel-h.png) no-repeat;width:147px; height:46px; float:right; display:block; font-size:16px; color:#6a6767; line-height:63px; text-align:center}
...
<!--    <div class="el"><a href="javaScript:void(0)">app下载</a>　|　<a href="javaScript:void(0)">敏行官网</a>　|　<a href="help.htm">帮助中心</a>　|　<a href="javaScript:void(0)">加入收藏夹</a></div> -->
  ...
  <div id="banner" class="slide">
      <div id="full-screen-slider">
            <ul id="slides">
                <li style="background: url('resource/image/cloud/12.png') no-repeat center top"><a href="javaScript:void(0)">
                    01</a></li>
            </ul>
       </div>
    ...
    <div class="nav" id="nav">
     ...
     <input id="USERID" type="text" onkeydown="doKeyDown(event)"  value=""   style="color:#000000;width:255px; height:40px; background:url(resource/image/cloud/user.png) no-repeat; line-height:40px; text-indent:40px; font-size:19px; border:none"/>
     </li>

      <li>
	 <input id="PASSWORD" onkeydown="doKeyDown(event)" type="password" value="" style="width:255px; height:40px; background:url(resource/image/cloud/pass.png) no-repeat; line-height:40px;   text-indent:40px; font-size:19px; color:#000000; border:none"/>
	  </li>
