function pageLoad() {
    ...
    function editInit() {
        ...
        if (Ext.isEmpty(record)) {
            Ext.MessageBox.alert('提示', '请先选择要修改的枚举值信息!');
            return;
        }
    ...
    function saveData() {
        var url = editmode=='add' ? 'enumerate_save.htm' : 'enumerate_update.htm';
