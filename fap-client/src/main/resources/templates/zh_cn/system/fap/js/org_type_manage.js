function pageLoad() {
    ...
    function editInit() {
        ...
        if (Ext.isEmpty(record)) {
            Ext.MessageBox.alert('提示', '请先选择要修改的机构信息!');
            return;
        }
    ...
    function saveData() {
        var url = editmode=='add' ? 'org_type_save.htm' : 'org_type_update.htm';
