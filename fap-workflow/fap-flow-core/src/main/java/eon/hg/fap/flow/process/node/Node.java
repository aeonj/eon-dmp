...
import eon.hg.fap.flow.command.impl.SaveHistoryActivityCommand;
...
import eon.hg.fap.flow.process.handler.NodeEventHandler;
...
public abstract class Node implements java.io.Serializable{
	...
	private void executeEventHandler(Context context,ProcessInstance processInstance,boolean enter){
		if(StrUtil.isNotEmpty(eventHandlerBean)){
