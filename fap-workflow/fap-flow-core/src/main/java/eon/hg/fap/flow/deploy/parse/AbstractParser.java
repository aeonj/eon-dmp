 ...
 * the License.
 ******************************************************************************/
package eon.hg.fap.flow.deploy.parse;
...
import eon.hg.fap.flow.process.node.FormElement;
import eon.hg.fap.flow.process.node.Mapping;
...
import eon.hg.fap.flow.utils.Utils;
...
public abstract class AbstractParser implements Parser,ApplicationContextAware {
	...
	protected void parseNodeCommonInfo(Element element, Node node) {
		...
		if(StrUtil.isNotBlank(heightAttr)){
